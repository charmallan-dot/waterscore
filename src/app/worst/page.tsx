...
export const metadata: Metadata = {
  ...
  description: 'See which water systems have the lowest water quality scores in the US.',
};

export default async function WorstPage() {
  const worst = await getWorstSystems(50);
